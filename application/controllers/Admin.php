...
class Admin extends CI_Controller {
	...
	public function level($param1 = "", $param2 = "") {
        ...
        if ($param1 == "add") {
            $this->user_model->add_level();
            redirect(site_url('admin/level'), 'refresh');
        }
        elseif ($param1 == "edit") {
            $this->user_model->edit_level($param2);
            redirect(site_url('admin/level'), 'refresh');
        }
        elseif ($param1 == "delete") {
            $this->user_model->delete_level($param2);
            redirect(site_url('admin/level'), 'refresh');
        }

        $page_data['page_name'] = 'level';
        $page_data['page_title'] = 'Level';
        $page_data['level'] = $this->user_model->get_level($param2);
	...
	public function mentor($param1 = "", $param2 = "") {
        ...
        if ($param1 == "add") {
            $this->user_model->add_mentor();
            redirect(site_url('admin/mentor'), 'refresh');
        }
        elseif ($param1 == "edit") {
            $this->user_model->edit_mentor($param2);
            redirect(site_url('admin/mentor'), 'refresh');
        }
        elseif ($param1 == "delete") {
            $this->user_model->delete_mentor($param2);
            redirect(site_url('admin/mentor'), 'refresh');
        }

        $page_data['page_name'] = 'mentor';
        $page_data['page_title'] = 'Mentor';
        $page_data['mentor'] = $this->user_model->get_mentor($param2);
        $this->load->view('backend/index', $page_data);
    }
    ...
    public function mentor_form($param1 = "", $param2 = "") {
        ...
        if ($param1 == 'add_mentor_form') {
			$page_data['user'] = $this->user_model->get_member()->result_array();
	...
	public function tipe_payment($param1 = "", $param2 = "") {
        ...
        if ($param1 == "add") {
            $this->user_model->add_tipe_payment();
            redirect(site_url('admin/tipe_payment'), 'refresh');
        }
        elseif ($param1 == "edit") {
            $this->user_model->edit_tipe_payment($param2);
            redirect(site_url('admin/tipe_payment'), 'refresh');
        }
        elseif ($param1 == "delete") {
            $this->user_model->delete_tipe_payment($param2);
            redirect(site_url('admin/tipe_payment'), 'refresh');
        }
        ...
        $page_data['tipe_payment'] = $this->user_model->get_tipe_payment($param2);
	...
	public function member($param1 = "", $param2 = "") {
        ...
        elseif ($param1 == "edit") {
            $this->user_model->edit_member($param2);
            redirect(site_url('admin/member'), 'refresh');
        }
        elseif ($param1 == "delete") {
            $this->user_model->delete_member($param2);
            redirect(site_url('admin/member'), 'refresh');
        }

        $page_data['page_name'] = 'member';
        $page_data['page_title'] = 'Member';
        $page_data['member'] = $this->user_model->get_member($param2);
        $this->load->view('backend/index', $page_data);
    }
