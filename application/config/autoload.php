...
*/
$autoload['model'] = array('user_model', 'crud_model', 'video_model', 'email_model', 'payment_model', 'lazyloaddata_model' => 'lazyload', 'addon_model', 'master_model', 'manajemen_kelas_model');
