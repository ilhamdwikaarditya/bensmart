    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <a href = "<?php echo site_url('admin/member_form/add_member_form'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i>Tambah Member</a>
            </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
