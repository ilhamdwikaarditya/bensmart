                                                                        ...
                                                                        <?php if ($lesson['active'] == '1') { ?>
                                                                            <div class="card-body thinner-card-body bg-warning">
                                                                                <div class="card-widgets display-none" id="widgets-of-lesson-<?php echo $lesson['id_class_materi_detail']; ?>">
                                                                                    <a title="Lihat" href="javascript::" onclick="showAjaxModal('<?php echo site_url('modal/popup/materi_detail_view/' . $lesson['id_class_materi_detail'] . '/' . $lesson['id_class_materi_section']); ?>', 'Materi Detail')"><i class="mdi mdi-eye"></i></a>
