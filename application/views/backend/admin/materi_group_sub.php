                      ...
                      <?php
                       foreach ($materi_group_sub->result_array() as $key => $materi_group_sub): ?>
                          <tr>
                              ...
                              <td><?php echo $materi_group_sub['id_materi_group_sub'] ?></td>
                              <td><?php echo $materi_group_sub['nm_materi_group_sub'] ?></td>
                              ...
                              <td><?php echo $materi_group_sub['nm_materi_group'] ?></td>
                              <td><?php echo $materi_group_sub['nm_jenjang'] ?></td>
                              <td><?php echo $materi_group_sub['cdate'] ?></td>
                              <td><?php echo $materi_group_sub['cuser'] ?></td>
                              <td>
