                              ...
                              <td>
                                  <div class="dropright dropright">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="<?php echo site_url('manajemen_kelas/manajemen_bundling_form/edit_manajemen_bundling_form/'.$data['id_bundling']); ?>">Edit</a></li>
                                        <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('manajemen_kelas/manajemen_bundling/delete/'.$data['id_bundling']); ?>');">Delete</a></li>
                                    </ul>
                                </div>
                              </td>
                          </tr>
