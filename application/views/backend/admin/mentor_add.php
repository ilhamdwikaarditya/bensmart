    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/mentor/add'); ?>" enctype="multipart/form-data" method="post">
                                ...
                                <div class="row">
                                    <div class="col-12">
										<div class="form-group row mb-3">
											<label class="col-md-3 col-form-label" for="user">User<span class="required">*</span></label>
											<div class="col-md-9">
											<select class="form-control select2" data-toggle="select2" name="id_user" id="id_user">
											  <option value="0"><?php echo get_phrase('none'); ?></option>
											  <?php foreach ($user as $datauser): ?>
													  <option value="<?php echo $datauser['id_user']; ?>"><?php echo $datauser['fullname']; ?></option>
											  <?php endforeach; ?>
											</select>
											</div>
										</div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="bio">Bio</label>
                                            <div class="col-md-9">
                                                <textarea name="bio" id = "summernote-basic" class="form-control"></textarea>
                                            </div>
                                        </div>
										<div class="form-group row mb-3">
