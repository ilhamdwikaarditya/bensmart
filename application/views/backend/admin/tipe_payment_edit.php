<?php
    $tipe_payment_data = $this->db->get_where('ref_type_payment', array('id_type_payment' => $id_type_payment))->row_array();
?>
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="nm_type_payment">Nama Tipe Payment <span class="required">*</span> </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="nm_type_payment" name="nm_type_payment" value="<?php echo $tipe_payment_data['nm_type_payment']; ?>" required>
                                            </div>
                                        </div>
