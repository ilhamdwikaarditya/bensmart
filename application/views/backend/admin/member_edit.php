    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('master/member/edit/'.$member_data['id_user']); ?>" enctype="multipart/form-data" method="post">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="firstname" name="firstname" value="<?php echo $member_data['firstname']; ?>" required>
                                            </div>
                                        </div>
										<div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="lastname">Nama Belakang <span class="required">*</span> </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="lastname" name="lastname" value="<?php echo $member_data['lastname']; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="email" id="email" name="email" class="form-control" value="<?php echo $member_data['email']; ?>" required disabled>
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
                                </div> <!-- end row -->
