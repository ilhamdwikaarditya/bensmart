    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-3">Form Tambah Member</h4>

                <form class="required-form" action="<?php echo site_url('master/member/add'); ?>" enctype="multipart/form-data" method="post">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="text-center">
                                            ...
                                            <p class="w-75 mb-2 mx-auto">Kamu cukup klik satu tombol ini</p>
