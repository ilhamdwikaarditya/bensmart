...
<div class="form-group">
    ...
    <input type="text" name="nm_class_materi_detail" id="nm_class_materi_detail" class="form-control" required disabled value="<?php echo $materi_detail['nm_class_materi_detail']; ?>">
</div>

<div class="form-group">
    <label for="section_id">Materi Section</label>
    <select class="form-control select2" data-toggle="select2" name="id_class_materi_section" id="id_class_materi_section" required disabled>
...
<div class="form-group">
    ...
    <input class="form-control" type="number" name="position" id="position" required disabled value="<?php echo $materi_detail['position']; ?>">
</div>

<div class="form-group">
    <label for="title">Url Materi</label>
    <input class="form-control" type="text" name="url_materi" id="url_materi" onkeyup="ajax_get_video_details(this.value)" required disabled value="<?php echo $materi_detail['url_materi']; ?>">
    ...
    <a href="<?php echo $materi_detail['url_materi']?>" target="_blank">Lihat Video</a>
</div>

<div class="form-group">
    <label for="title">Durasi</label>
    <input class="form-control" type="text" name="duration" id="duration" required disabled value="<?php echo $materi_detail['duration']; ?>">
</div>

<div class="form-group">
    <label for="title">Deskripsi</label>
    <textarea class="form-control" type="text" name="desc" id="desc" required disabled><?php echo $materi_detail['desc']; ?></textarea>
</div>
