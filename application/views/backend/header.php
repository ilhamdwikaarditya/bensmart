    ...
    <div class="container-fluid">
        ...
        <a href="<?php echo site_url($this->session->userdata('role')); ?>" class="topnav-logo" style = "min-width: unset;">
            <span class="topnav-logo-lg">
                <img src="<?php echo base_url('uploads/system/'.get_frontend_settings('light_logo'));?>" alt="" height="25">
            </span>
        ...
        <ul class="list-unstyled topbar-right-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                ...
                <span  style="color: #fff;">
                    ...
                    ?>
                    <span class="account-user-name"><?php echo $logged_in_user_details['fristname'];?></span>
