    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <a href="<?php echo site_url('mentor/manajemen_kelas'); ?>" class="alignToTitle btn btn-outline-secondary btn-rounded btn-sm"> <i class=" mdi mdi-keyboard-backspace"></i> Kembali</a>
                </h4>

                <form class="required-form" action="<?php echo site_url('mentor/mentor/add_mentor/' . $id_class); ?>" enctype="multipart/form-data" method="post">
                    <div id="progressbarwizard">
                        ...
                        <ul class="nav nav-pills nav-justified form-wizard-header mb-3">
                            <li class="nav-item">
                                <a href="#materi" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                    <i style="color: white;" class="mdi mdi-crop-square mr-1 bg-white"></i>
                            ...
                            <div class="tab-pane" id="materi">
                                <div class="row justify-content-center">
                                    <div class="col-xl-12 mb-4 text-center mt-3">
                                        ...
                                        <!-- <a href="javascript::void(0)" class="btn btn-outline-primary btn-rounded btn-sm ml-1" onclick=""><i class="mdi mdi-send"></i> Kirim Materi Detail</a> -->
                                    </div>
                                                                    ...
                                                                    <div class="card text-secondary on-hover-action mb-2" id="<?php echo 'lesson-' . $lesson['id_class_materi_detail']; ?>">
                                                                        <?php if($lesson['active'] == '0'){ ?>
                                                                            ...
                                                                            <div class="card-widgets display-none" id="widgets-of-lesson-<?php echo $lesson['id_class_materi_detail']; ?>">
                                                                                <a title="Dokumen" href="<?php echo site_url('mentor/manajemen_kelas_form/detmateri_dokumen_manajemen_kelas_form/'.$lesson['id_class_materi_detail']); ?>" ><i class="mdi mdi-file-outline"></i></a>
                                                                                <a title="Edit" href="javascript::" onclick="showAjaxModal('<?php echo site_url('modal/popup/materi_detail_edit/' . $lesson['id_class_materi_detail'] . '/' . $lesson['id_class_materi_section']); ?>', 'Edit Materi Detail')"><i class="mdi mdi-pencil-outline"></i></a>
                                                                                <a title="Hapus" href="javascript::" onclick="confirm_modal('<?php echo site_url('mentor/materi_detail/' . $id_class . '/delete' . '/' . $lesson['id_class_materi_detail']); ?>');"><i class="mdi mdi-window-close"></i></a>
                                                                                <a title="Kirim" href="javascript::" onclick="confirm_modal('<?php echo site_url('mentor/materi_detail/' . $id_class . '/send' . '/' . $lesson['id_class_materi_detail']); ?>');"><i class="mdi mdi-send"></i></a>
                                                                            </div>
                                                                        ...
                                                                        <?php }  else if($lesson['active'] == '2') { ?>
                                                                            ...
                                                                            <div class="card-widgets display-none" id="widgets-of-lesson-<?php echo $lesson['id_class_materi_detail']; ?>">
                                                                                ...
                                                                                <a title="Hapus" href="javascript::" onclick="confirm_modal('<?php echo site_url('mentor/materi_detail/' . $id_class . '/delete' . '/' . $lesson['id_class_materi_detail']); ?>');"><i class="mdi mdi-window-close"></i></a>
                                                                                <a title="Kirim" href="javascript::" onclick="confirm_modal('<?php echo site_url('mentor/materi_detail/' . $id_class . '/send' . '/' . $lesson['id_class_materi_detail']); ?>');"><i class="mdi mdi-send"></i></a>
                                                                                <a title="Komentar" href="javascript::" onclick="showAjaxModal('<?php echo site_url('modal/popup/materi_detail_comment/' . $lesson['id_class_materi_detail'] . '/' . $lesson['id_class_materi_section']); ?>', 'Ditolak')"><i class="mdi mdi-comment"></i></a>
                                                                            </div>
                                                                            <h5 class="card-title mb-0">
                                                                                <span class="font-weight-light">
                                                                                    <?php
