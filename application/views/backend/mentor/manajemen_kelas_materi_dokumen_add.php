                                                                    ...
                                                                    <?php if ($detail['active'] == '0') { ?>
                                                                        <div class="card-body thinner-card-body">
                                                                            <div class="card-widgets display-none" id="widgets-of-lesson-<?php echo $document['id_class_materi_dokumen']; ?>">
                                                                                ...
                                                                                <a href="javascript::" onclick="confirm_modal('<?php echo site_url('mentor/materi_detail_dokumen/' . $id_class_materi_detail . '/delete' . '/' . $document['id_class_materi_dokumen']); ?>');"><i class="mdi mdi-window-close"></i></a>
                                                                            </div>
