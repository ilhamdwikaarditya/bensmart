...
<!-- Mirrored from landkit.goodthemes.co/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Jul 2020 01:31:37 GMT -->
...
<head>
    ...
    <title>Bensmart | Kelas Online</title>
    <link rel="shortcut icon" type="image/jpg" href="assets/img/logoBensmart.png"/>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
      <div class="container">
        ...
        <a class="navbar-brand" href="index.html">
          <img src="assets/img/logo_text_bensmart.png" class="navbar-brand-img" height="17" alt="...">
        </a>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-7 col-lg-6 order-md-1" data-aos="fade-up">
            ...
            <!-- Heading -->
            <h1 class="display-5 text-center text-md-left font-weight-bold">
              Belajar makin nyaman dimasa New Normal, bersama Kelas Online Bensmart
            </h1>

            <!-- Text -->
            <p class="lead text-center text-md-left text-muted mb-5">
              Belajar live streaming dengan Pengajar berpengalaman. Materi dapat diulang kembali kapan saja di mana saja.
            </p>
            ...
            <form>
              <div class="input-group">
                ...
                <input type="search" class="form-control pl-2 border-left-0" placeholder="Temukan Kelasmu" aria-label="Cari kelas yang kamu inginkan" aria-describedby="searchAddon">
              </div>
            </form> -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 col-md-4" data-aos="fade-up" data-aos-delay="50">
            ...
            <!-- Heading -->
            <h3>
              Tentukan sendiri waktu belajar
            </h3>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <!-- Heading -->
            <h2 class="mb-7 mb-md-9">
              Setelah mengikuti apa kata mereka?
            </h2>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-between">
          <div class="col-12 col-md-5 order-md-1">
            ...
            <!-- Badge -->
            <span class="badge badge-primary-soft mb-3">
          ...
          <div class="col-12 col-md-6 order-md-2">
            ...
            <!-- Card -->
            <div class="card card-border border-primary shadow-lg">
              <div class="card-body">
                ...
                <div class="list-group list-group-flush">
                  <div class="list-group-item d-flex align-items-center">
                    ...
                    <div class="mr-auto">
                      ...
                      <p class="font-size-sm text-muted mb-0">
                        Dengan penjelasan praktis & menarik.
                      </p>

                    </div>
                      
                    <!-- Check -->
                    <div class="badge badge-rounded-circle badge-primary ml-4">
                  ...
                  <div class="list-group-item d-flex align-items-center">
                    ...
                    <div class="mr-auto">
                      ...
                      <!-- Text -->
                      <p class="font-size-sm text-muted mb-0">
                        Dengan soal latihan aktual & prediktif
                      </p>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <!-- Text -->
            <p class="font-size-lg text-gray-700 mb-7 mb-md-9 mt-n2">
              Materi Belajar yang Dapat Diikuti.
            </p>
            ...
            <div class="card card-row shadow-light-lg mb-6">
              <div class="row no-gutters">
                ...
                <div class="col-12 col-md-4 ">
                  ...
                  <!-- Image (placeholder) -->
                  <!-- <img src="assets/img/photos/photo-1.jpg" alt="..." class="card-img-left img-fluid" > -->

                  <div class="limit">
                    <img src="assets/img/photos/photo-1.jpg" alt="..." class="card-img-left" style="display: block; margin: 0 auto;" >
                  </div>
                  <style type="text/css">
                    .limit{
                        width: 100%;
                  ...
                  <div class="px-6">
                    <div class="d-flex justify-content-between">
                      ...
                      <h4 class="font-weight-bold mt-6">
                        Belajar Matematika Sehari Semalaman
                      </h4>
    ...
    <!-- CTA
    ================================================== -->
    <section class="pt-14 pt-md-14 pb-11 bg-gray-200">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <h1 class="display-4 text-center">
              Ayo gabung bersama komunitas Bensmart.
            </h1>

            <!-- Text -->
            <p class="font-size-lg text-muted mb-6">
              Belajar bersama siswa Bensmart lainnya dengan mentor-mentor terbaik dari seluruh penjuru Negeri.
            </p>
    ...
    <!-- FOOTER
    ================================================== -->
    <footer class="pt-8 pt-md-10 pb-5 bg-dark">
      <div class="container">
        <div class="row mb-8">
          <div class="col-12 col-md-4 col-lg-3">
        
            <!-- Brand -->
            <img src="assets/img/logoBensmart.png" alt="..." class="mb-5" height="150">
          ...
          <div class="col offset-md-4 offset-lg-0">
            ...
            <ul class="list-unstyled text-muted mb-6 mb-md-8 mb-lg-0">
              ...
              <li class="mb-3">
                <a href="#!" class="text-reset">
                  Aplikasi Pesan Guru Privat
                </a>
              </li>
              <li>
                <a href="#!" class="text-reset">
                  Les Privat Video Streaming
                </a>
              </li>
              <li>
                <a href="#!" class="text-reset">
        ...
        <div class="row justify-content-between">
          <div class="col">
            <h5 class="text-white">
              © 2021. Bensmart. All Right Reserved
            </h5>
          </div>
...
<!-- Mirrored from landkit.goodthemes.co/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Jul 2020 01:34:03 GMT -->
</html>
