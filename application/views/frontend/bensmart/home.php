  ...
  <div class="container">
	<div class="row align-items-center">
	  <div class="col-12 col-md-5 col-lg-6 order-md-2">
		...
		<!-- Image -->
		<img src="<?php echo base_url().'assets/frontend/bensmart/img/illustrations/illustration-2.png' ?>" class="img-fluid mw-md-150 mw-lg-130 mb-6 mb-md-0" alt="..." data-aos="fade-up" data-aos-delay="100">
	  ...
	  <div class="col-12 col-md-7 col-lg-6 order-md-1" data-aos="fade-up">
		...
		<div class="text-center text-md-left">
		  <a href="<?php echo site_url('publik/class_all'); ?>" class="btn btn-primary btn-sm shadow lift mr-1">
...
<?php endif; ?>
                ...
                <!-- Text -->
                <h6 class="text-muted">
                  <?php echo strip_tags(html_entity_decode($top_course['desc_short'])); ?>
                </h6>
               <div class="row align-items-center">
                  <p>                
                ...
                <div class="row align-items-center mt-n4">
                  <p>
                    ...
                    <h6 class="align-items-center pb-2 ml-1 text-gray-700"><?php echo $top_course['jmlmateri']; ?> Materi, Total Durasi: 
					<?php
                ...
                <div class="row align-items-center mt-n4">
                  <p>
					...
					<?php
						...
						where b.active = '1' and a.id_class = ".$top_course['id_class'].";");
  ...
  <div class="container">
	<div class="row justify-content-center">
	  <div class="col-12 col-md-10 col-lg-8 text-center">
		...
		<!-- Button -->
		<a href="<?php echo site_url('home/login'); ?>" target="" class="btn btn-primary btn-sm lift">
